...
If you contributed to Bisq at some point in the past, you will need to specify a **new** mainnet BSQ address to become part of the genesis BSQ distribution. See instructions at the bottom of the linked page.
