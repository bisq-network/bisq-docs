...
The Bisq mobile notifications app lets you get notifications from Bisq desktop on your iPhone or Android device. This doc explains how to set it up and how it works.
