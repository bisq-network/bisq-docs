...
TIP: For complete instructions on each of the steps above, read <<getting-started#,Getting Started with Bisq>>.
...
== Next steps
 ...
 - Ask questions in the Bisq https://bisq.community[Forum] or https://keybase.io/team/bisq[Keybase]
