...
*Feedback.* Please ask questions and provide feedback on this document via issues and pull requests in the <<docs-repo>>. Alternatively, post questions in the https://forum.bisq.io[Bisq Forum], chat with us in the https://bisq-slack.herokuapp.com/[Bisq Slack workspace] or email the authors directly.
...
On the last three days of each month, we vote on contribution requests and other proposals that have been submitted throughout the month.

_Status:_ *pending.* The first voting period will begin on October 29th, 2017.
...
_Status:_ *in progress;* initial bonding levels will be set, and founders will be officially bonded into all roles by October 31st, 2017.
...
// TODO: add links / footnotes for rough consensus. https://tools.ietf.org/html/rfc7282
...
An _administrator_ is a Bisq contributor who is responsible for a TODO: finish
...
// TODO: preface to explain primacy of GitHub as a collaboration tool for the DAO
...
// TODO: add communication tools, e.g. Slack, IRC?
