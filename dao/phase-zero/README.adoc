...
See https://github.com/bisq-network/compensation/issues/1 for an example compensation request.

Once submitted, your request will be added to the [[voting-spreadsheet]] where stakeholders can <<vote,vote>> on it.
