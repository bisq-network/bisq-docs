...
image::volume.png[Bisq Trading Volume in USD]
...
image::bsq-distribution.png[Initial BSQ distribution]
{empty}
...
image::limitations.png[Limitations]
{empty}
...
image::bsq-creation-destruction.png[How BSQ is issued and destroyed]
