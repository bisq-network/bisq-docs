...
=== Infrastructure and Notable Roles

==== Governance

 * <<proposals#, Proposals>>
    ** <<proposals#maintainer, Proposals Maintainer>>
 * <<roles#, Roles>>
    ** <<roles#maintainer, Roles Maintainer>>

==== Network Infrastructure

 * <<btcnode#, Bitcoin Core Nodes>>
    ** <<btcnode#operator, Bitcoin Core Node Operator>>
 * <<exchange/howto/run-seednode#, Bisq Seed Nodes>>
    ** <<exchange/howto/run-seednode#seed-node-operators, Bisq Seed Node Operator>>
 * <<exchange/howto/run-price-relay-node#, Bisq Price Nodes>>
    ** <<exchange/howto/run-price-relay-node#price-relay-node-operators, Bisq Price Node Operator>>
