...
Bisq relies on a decentralized arbitration system to ensure that traders fulfill their obligations. See the https://bisq.network/docs/arbitration-system.pdf[arbitration system] document for more details on how this system works.
